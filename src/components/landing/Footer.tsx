    ...
    <footer className="border-t border-gray-100 py-16 px-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-14">
          ...
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-4">Social</h4>
            <ul className="space-y-3">
              <li><a href="https://www.instagram.com/dressrdotapp/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-black transition-colors">Instagram</a></li>
              <li><a href="https://www.linkedin.com/company/dressrai/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-black transition-colors">LinkedIn</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-black rounded-md flex items-center justify-center">
              <span className="text-white font-sign text-xs">d</span>
            </div>
            <span className="font-sign text-lg">dressr</span>
          </div>
          <p className="text-xs text-gray-400">© 2025 dressr. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
